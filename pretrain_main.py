...
def main(para, update_params_dict, logger):
    ...
    para.model_save_dir = os.path.join('model_save', param_str)
    data_utils.safe_make_dir(para.model_save_dir)

    sc_data = sc.read_h5ad('processed_data/sc_ccle_data.h5ad')
...
if __name__ == '__main__':
    ...
    logger = setup_logger(log_dir='log/', log_filename_prefix="pre_training_parameters")
